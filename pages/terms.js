          ...
          <div className="items-center flex flex-wrap">
            <div className="w-full  ml-auto mr-auto px-4">
              ...
              <Text>
                ...
                and use of the http://0xaloysius.x website as well as any other
            ...
            <Collapse.Group splitted className="text-trueZinc-700">
              ...
              <Collapse title="PRIVACY POLICY">
                <Text>
                  ...
                  Use. Please be advised the Site and the Marketplace Offerings
                  are hosted in the United States. If you access the Site or the
                  Marketplace Offerings from any other region of the world with
                  laws or other requirements governing personal data collection,
                  use, or disclosure that differ from applicable laws in the
                  United States, then through your continued use of the Site,
                  you are transferring your data to the United States, and you
                  agree to have your data transferred to and processed in the
                  United States.
                </Text>
              </Collapse>
