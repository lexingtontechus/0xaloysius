              ...
              <div className="items-center flex flex-wrap">
                <div className="w-full  ml-auto mr-auto px-4">
                  ...
                  <div className="text-sm text-trueZinc-700">
                    ...
                    provides an online marketplace for the following goods,
                    products, and/or services: Consulting, management & business
                    services (the “Marketplace Offerings”). In order to help
                    make the Site a secure environment for the purchase and sale
                    of Marketplace Offerings, all users are required to accept
                    and comply with these Terms of Use. You agree that by
                    ...
                    USE IMMEDIATELY. Supplemental terms and conditions or
                    ...
                    the “Last updated” date of these Terms of Use, and you waive
                    any right to receive specific notice of each such change. It
                    is your responsibility to periodically review these Terms of
                ...
                >
                  ...
                  <Collapse title="DISPUTE RESOLUTION">
                    ...
                    <div className="h2 text-trueZinc-700">
                      Binding Arbitration
                    </div>
                    <div className="text-sm text-trueZinc-700">
                    ...
                    <div className="h2 text-trueZinc-700">Restrictions</div>
                    <div className="text-sm text-trueZinc-700">
