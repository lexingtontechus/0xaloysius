...
export default function Terms() {
  return (
    <main className="mx-auto">
      <div className="hero min-h-[250px] svg-terms">
      ...
      <section className="relative p-4 mb-8">
        <div className="container mx-auto px-8">
          <div className="flex flex-wrap items-center">
            ...
            <div
              tabIndex={0}
              className="collapse-arrow collapse my-2 rounded-md bg-secondary text-primary-content focus:bg-accent"
            >
            ...
            <div
              tabIndex={1}
              className="collapse collapse-arrow bg-secondary text-primary-content focus:bg-accent my-2 rounded-md"
            >
