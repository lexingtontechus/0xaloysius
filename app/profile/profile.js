      ...
      <div className="hero min-h-screen bg-secondary svg-profile">
        ...
        <div className="hero-content text-center">
          <div className="max-w-lg">
            ...
            <h2 className="pt-4 pb-8 text-3xl font-semibold">
              Building strategic partnerships across the 0xaloysius portfolio.
            </h2>
        ...
        <div className="my-8 text-center">
          <div className="flex flex-wrap justify-center">
            <div className="w-full lg:w-9/12 px-4">
              ...
              <h3 className="text-xl font-semibold leading-normal my-4">
                Portfolio & industry focus in,
              </h3>
              <ul className="list-inside mx-auto px-8 my-8 max-w-lg text-left">
