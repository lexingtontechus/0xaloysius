  ...
  return (
    <div className="navbar px-2">
      <div className="flex flex-1 items-start justify-start cursor-pointer">
        <Link
          href="/"
          className="inline-flex h-content w-auto stroke-2 fill-secondary"
        >
          <Brand className="max-h-[50px] max-w-[100px]" />
        </Link>
      </div>
      ...
      <div className="navbar-end flex-none">
        <div className="join">
          ...
          <button className="btn btn-primary glass fill-secondary join-item w-16">
            <Link href="/portfolio">
              <svg
                height="1.5em"
                viewBox="0 0 576 512"
          ...
          {theme === "xlight" ? (
            <button
              className="btn btn-primary glass join-item"
...
function Surf() {
  return (
    <svg
      ...
      width="30"
      height="30"
      className="stroke-2 stroke-purple-700"
    >
...
function Beach() {
  return (
    <svg
      ...
      width="30"
      height="30"
      className="stroke-2 stroke-amber-300"
    >
